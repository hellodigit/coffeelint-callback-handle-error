  ...
  module.exports = CallbackHandleError = (function() {
    ...
    CallbackHandleError.prototype.handlesError = function(code_node, var_name) {
      ...
      code_node.traverseChildren(true, function(child) {
        var arg, found_non_usage, function_name, i, inner_child_type, j, k, key, l, len, len1, len2, len3, nameType, node_type, non_usage_length, obj, param, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, valueType;
        ...
        switch (node_type) {
          ...
          case 'Code':
            ...
            break;
          case 'Value':
            if (!((ref4 = (ref5 = child.base) != null ? ref5.value : void 0) === (void 0) || ref4 === var_name || ref4 === 'this') && !obj_idents[child.base.value]) {
          ...
          case 'Param':
            ...
            if (nameType === 'Arr' || nameType === 'Obj') {
              ...
              if ((ref7 = child.value) != null ? ref7.base : void 0) {
                valueType = getNodeType(child.value.base);
                if (valueType === nameType) {
                  if (!child.value.base.objects.length) {
                    for (l = 0, len3 = obj_idents_pending.length; l < len3; l++) {
                      key = obj_idents_pending[l];
                      obj_idents[key] = 1;
                    }
                    obj_idents_pending = [];
                  }
